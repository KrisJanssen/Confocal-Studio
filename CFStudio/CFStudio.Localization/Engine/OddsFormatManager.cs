// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OddsFormatManager.cs" company="">
//   
// </copyright>
// <summary>
...
namespace CFStudio.Localization.Engine
{
    ...
    public sealed class OddsFormatManager : DependencyObject
    {
        ...
        /// </summary>
        [DesignOnly(true)]
        public static readonly DependencyProperty DesignOddsFormatProperty =
            ...
            if (!Enum.IsDefined(typeof(OddsFormatType), args.NewValue))
            {
                ...
                else
                {
                    throw new InvalidCastException(
                        string.Format("\"{0}\" not defined in Enum OddsFormatType", args.NewValue));
                }
            }
            else
            {
