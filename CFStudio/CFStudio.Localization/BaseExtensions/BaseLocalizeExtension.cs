// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BaseLocalizeExtension.cs" company="">
//   
// </copyright>
// <summary>
...
namespace CFStudio.Localization.BaseExtensions
{
    using System;
    ...
    public abstract class BaseLocalizeExtension<TValue> : MarkupExtension, IWeakEventListener, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseLocalizeExtension{TValue}"/> class. 
        ...
        public string Assembly
        {
            get
            {
                return this.assembly ?? this.dialogAssembly;
            }
        ...
        public string Dict
        {
            get
            {
                return this.dict ?? LocalizeDictionary.ResourcesName;
            }
        ...
        public string ResourceIdentifierKey
        {
            get
            {
                return string.Format("{0}:{1}:{2}", this.Assembly, this.Dict, this.Key ?? "(null)");
            }

            set
            {
                LocalizeDictionary.ParseKey(value, out this.assembly, out this.dict, out this.key);
            }
        }
        ...
        public bool SetBinding(DependencyObject targetObject, object targetProperty)
        {
            if (!(targetProperty is DependencyProperty || targetProperty is PropertyInfo))
            {
                throw new ArgumentException(
                    "The targetProperty should be a DependencyProperty or PropertyInfo!", 
                    "targetProperty");
            }
            ...
            if (!foundInWeakReferences)
            {
                ...
                this.SetTargetValue(targetObject, targetProperty, output);
